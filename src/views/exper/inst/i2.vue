<template>
    <div class="inst_2">
        ...
        <div class="content">
            ...
            <p><strong>收益:</strong> 您在本实验中的主要收益是您对于科学研究的贡献！同时，为了补偿您参加研究所花费的时间和精力，我们将给予您一定的经济补偿 (¥10或者¥40)，该经济补偿将现场进行发放。为保证本研究的数据质量，本问卷设置了几个注意力的检测题，这几个题目的答案非常明显，如果您觉得是就选非常同意，不是就选非常不同意，不要选其他选项，但是对于其他题目请按照自己的看法去评分。注意力检测题回答如果不符合常识，即被判断为错误。如果有1道及以上注意力检测题回答错误，或者实验中有明显随意填写的情况，您的数据会被提前设置好的程序自动识别为无效。如果这种情况发生，您的数据将无法纳入到最终的数据分析之中，您的报酬为10元。希望您能够理解本研究的设定，认真对待实验。当然，如果您认为本研究的这个设定不符合您的偏好，您有权选择不参加本次实验。</p>
